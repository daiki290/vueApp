  ...
  <div class="container">
    ...
    <form @submit.prevent="singup">
      ...
      <div class="buttonArea">
        <button class="btn-border">CREATE ACCOUNT</button>
      </div>
    </form>
  </div>
</template>
    ...
    singup () {
      if (this.username && (this.password === this.passwordConfirm)) {
        this.$cognito.signUp(this.username, this.password)
          ...
          .catch(err => {
            this.$emit('parentMessage', 'Create account failed. Try again.')
            console.log(err.message)
          })
      } else {
        this.$emit('parentMessage', 'Password is invalid. Try again.')
      }
    }
  }
}
